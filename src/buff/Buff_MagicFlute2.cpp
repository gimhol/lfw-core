#include "lfw-core/buff/Buff_MagicFlute2.h"
...
BuffResult Buff_MagicFlute2::on_tick(Entity *attacker, Entity *victim)
{
  if (!victim)
...
BuffResult Buff_MagicFlute2::on_update(Entity *attacker, Entity *victim)
{
  if (!victim)
    return BuffResult::Del;
